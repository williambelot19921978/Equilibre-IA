...
export default defineConfig({
  ...
  reporter: [
    ["list"],
    ["json", { outputFile: "tests/e2e/reports/epic4b-results.json" }],
  ],
  outputDir: "tests/e2e/test-results/epic4b",
  use: {
    baseURL,
  ...
  projects: [
    ...
    {
      name: "epic4b-desktop",
      testMatch: "**/humanModel/certification.spec.ts",
      grepInvert: /viewport mobile/i,
      dependencies: ["epic4b-setup"],
      use: {
